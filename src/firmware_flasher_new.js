...
var onReceiveCallback = function(info){
   if(DDOS)
   {
      ...
      //  console.log(LOG + "Now we have: " + sIncomingData);
        ...
        console.log(sIncomingData+" huuuuui "+iDeviceID + " ch " +sIncomingData[iSerialNumberOffset+5]+" tr " + sIncomingData[iSerialNumberOffset+6]+" tr " + sIncomingData[iSerialNumberOffset+10]);
  ...
  //  console.warn("shiiiiiii");
    qport.flush((err)=>{
  console.warn("AAAA MUSORA SOSAT'!");
